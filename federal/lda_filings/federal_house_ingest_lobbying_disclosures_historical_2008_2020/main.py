...
house_index = 'lobbying-disclosures'
...
def federal_house_ingest_lobbying_disclosures_historical_2008_2020(message, context):
    ...
    for idx, option in enumerate(options):
        ...
        for hit in hits:
            ...
            actions.append(
                {
                    '_op_type': 'index',
                    '_index': 'house-lobbying-disclosures-2008+',
                    '_id': hit['_id'],
