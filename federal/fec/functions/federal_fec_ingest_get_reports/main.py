...
def get(datestring, page):
    response = requests.get('https://api.open.fec.gov/v1/filings/?per_page=100&api_key=' + fec_api_key + '&min_receipt_date=' + datestring + '&max_receipt_date=' + datestring + '&page=' + str(page))
